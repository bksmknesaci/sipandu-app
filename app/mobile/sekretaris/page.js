...
export default function MobileSekretaris() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header */}
      <div className="bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-700 pt-12 pb-8 px-5 relative overflow-hidden">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-extrabold text-white tracking-tight">Sekretaris</h1>
            <p className="text-blue-200 text-xs font-medium mt-0.5">Menu absensi & kehadiran kelas</p>
          </div>
        </div>
      </div>
