...
import { 
  Award, AlertTriangle, FileWarning, HeartPulse, CalendarDays, BarChart3, Shield, ArrowLeft
} from 'lucide-react';

const MENUS = [
  { title: 'Entri Reward', desc: 'Input poin penghargaan siswa', icon: Award, href: '/wali-kelas/entri-reward', gradient: 'linear-gradient(135deg, #059669, #10b981)', shadow: 'rgba(16,185,129,0.4)' },
...
export default function MobileWaliKelas() {
  const router = useRouter();

  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header */}
      <div className="bg-gradient-to-br from-indigo-600 via-indigo-700 to-purple-700 pt-12 pb-8 px-5 relative overflow-hidden">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-extrabold text-white tracking-tight">Wali Kelas</h1>
            <p className="text-indigo-200 text-xs font-medium mt-0.5">Menu penilaian & monitoring siswa binaan</p>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          {MENUS.map((menu, idx) => {
            ...
            return (
              ...
              >
                {/* Dekorasi lingkaran pojok kanan bawah */}
                ...
                {/* Dekorasi lingkaran kecil pojok kiri atas */}
                ...
                <div className="relative z-10">
                  <div
                    ...
                    style={{
                      animation: `bounceSlow 2s ease-in-out ${delay}ms infinite`,
                    }}
                  >
